...
age = (df_cleaned['Age'] == 0).sum()
height = (df_cleaned['Height'] == 0).sum()
weight = (df_cleaned['Weight'] == 0).sum()
...
print(df_cleaned[categorical_feature].isin(["", " "]).sum())
print("================================================")
# Cek nilai string yang umum dipakai sebagai missing
print("Jumlah 'NA' atau 'null' atau 'nan' string:")
print(df_cleaned[categorical_feature].isin(["NA", "null", "nan"]).sum())
...
model_xgb = XGBClassifier(max_depth = 5, n_estimators = 168,
                          random_state = 9, learning_rate = 0.04396509567813328, n_jobs = -1)
...
* max_depth = 5: Menentukan kedalaman maksimal setiap pohon. Jika tidak diatur, pohon akan terus berkembang hingga semua daun menjadi murni atau jumlah sampel di daun kurang dari nilai minimal yang ditentukan.

* learning_rate: Mengatur seberapa besar pengaruh tiap pohon baru terhadap model akhir. Dengan kata lain, ini mengontrol laju pembelajaran untuk mencegah model menjadi terlalu kompleks (overfitting).

* n_estimators: 168, Jumlah pohon yang dibangun untuk mengurangi kesalahan dari prediksi sebelumnya, meningkatkan akurasi model secara bertahap.
